  ...
  <div class="row content">
    ...
    <a href="./index.php"><img src="./images/philomena-logo-wit.png" width="60%"></a>
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="./inloggen_klant.php">Inloggen Klant</a></li>
        <li class="active"><a href="./inloggen_medewerker.php">Inloggen Medewerker</a></li>
      </ul><br>
    </div>
    ...
    <div class="col-sm-4" style="top:100px">
       <div id="inlogblok">
       <form action= "./inloggen_medewerker_query.php" name="inloggen" method="POST" enctype="multipart/form-data">
              <h3>Inlogportaal medewerker</h3>
